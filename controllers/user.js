...
exports.resendEmailVerificationToken = async (req, res) => {
  ...
  transport.sendMail({
    ...
    subject: 'Email Verification',
    html: `
      <h1>New OTP has been sent to your registered email account.</h1>
    `,
  });
...
exports.resetPassword = async (req, res) => {
  ...
  transport.sendMail({
    ...
    html: `
      ...
      <p>Now you can use a new password</p>
    `,
  });

  res.json({
    message: 'Password reset successfully, now you can use a new password.',
  });
};
